...
# Remote Desktop (WSL) Configuration
REMOTE_DESKTOP_HOST = os.environ.get("OCR_REMOTE_DESKTOP_HOST")
REMOTE_DESKTOP_USER = os.environ.get("OCR_REMOTE_DESKTOP_USER") or os.environ.get("USER")
REMOTE_DESKTOP_REPO_DIR = os.environ.get("OCR_REMOTE_DESKTOP_REPO_DIR")
REMOTE_DESKTOP_SOURCE_DIR = os.environ.get("OCR_REMOTE_DESKTOP_SOURCE_DIR")
REMOTE_DESKTOP_SSH_OPTS = os.environ.get("OCR_REMOTE_DESKTOP_SSH_OPTS", REMOTE_SSH_OPTS)
REMOTE_DESKTOP_WSL_DISTRO = os.environ.get("OCR_REMOTE_DESKTOP_WSL_DISTRO")
REMOTE_DESKTOP_ENABLED = bool(REMOTE_DESKTOP_HOST)
