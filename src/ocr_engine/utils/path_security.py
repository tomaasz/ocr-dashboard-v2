...
def validate_profiles_dir(path_input: Optional[str] = None) -> Path:
    ...
    Examples:
        ...
        PosixPath('/home/user/.cache/ocr-dashboard-v2')
        >>> validate_profiles_dir("/home/user/custom")
        PosixPath('/home/user/custom')
    """
    default = str(Path.home() / ".cache/ocr-dashboard-v2")
...
def validate_cache_dir(path_input: Optional[str] = None, allow_tmp: bool = True) -> Path:
